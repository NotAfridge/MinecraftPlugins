...
public class QuitJoinDeath implements Listener {
    ...
    public void rocketRemoveOnQuit(PlayerQuitEvent event) {
        rocketFunctions.disableRocketBoots(event.getPlayer(), false, false, false, false, false, false);
    }
    ...
    public void rocketRemoveOnDeath(PlayerDeathEvent event) {
        rocketFunctions.disableRocketBoots(event.getEntity(), false, false, false, false, false, false);
    }
